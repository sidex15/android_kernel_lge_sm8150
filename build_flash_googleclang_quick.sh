...
export CLANG_PATH=~/toolchains/android_prebuilts_clang_host_linux-x86_clang-6443078/bin
...
export LD_LIBRARY_PATH=~/toolchains/android_prebuilts_clang_host_linux-x86_clang-6443078/lib64:$LD_LIBRARY_PATH
